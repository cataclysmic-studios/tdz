...
do
	...
	function FixedCamera:create(controller)
		...
		return components:addComponent(camera, "common/src/client/cameras/fixed@FixedCamera")
	end
	...
	do
		...
		Reflect.defineMetadata(FixedCamera, "identifier", "common/src/client/cameras/fixed@FixedCamera")
	end
end
